                        ...
                        try {
                            ...
                            if (reviews.length > 0) {
                                ...
                                const totals = reviews.reduce((acc, review: ReviewDocument) => ({
                                    ...
                                    internalCommunication: acc.internalCommunication + (review.internalCommunication || 0),
                                    ...
                                    workInclusion: acc.workInclusion + (review.workInclusion || 0),
                                }), {
                                    workEnvironment: 0,
                                    salary: 0,
                                    benefits: 0,
                                ...
                                reviewAverages = {
                                    ...
                                    internalCommunication: Number((totals.internalCommunication / reviews.length).toFixed(1)),
                                    ...
                                    workInclusion: Number((totals.workInclusion / reviews.length).toFixed(1)),
                                };
                            }
                        } catch (reviewError) {
                                        ...
                                        {isLoading ? (
                                            ...
                                            companies.map((company) => (
                                                ...
                                                >
                                                    ...
                                                    <td className="px-1 py-3 whitespace-nowrap text-center">
                                                        <span className={`text-xs font-medium ${company.internalCommunication ? 'text-slate-700 dark:text-slate-300' : 'text-slate-400'}`}>
                                                            {company.internalCommunication ? company.internalCommunication.toFixed(1) : '-'}
                                                        </span>
                                                    </td>

                                                    {/* Work Inclusion */}
                                                    <td className="px-1 py-3 whitespace-nowrap text-center">
                                                        <span className={`text-xs font-medium ${company.workInclusion ? 'text-slate-700 dark:text-slate-300' : 'text-slate-400'}`}>
                                                            {company.workInclusion ? company.workInclusion.toFixed(1) : '-'}
                                                        </span>
                                                    </td>
                                                </tr>
                                            ))
