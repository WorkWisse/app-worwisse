...
import { mockCompanies, mockReviews, getCompanyById, getCompanyReviews } from '../../data/mockCompanies';
    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-slate-600 dark:text-slate-300">Cargando información de la empresa...</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <>
      <Head>
        ...
        />
        <meta property="og:title" content={`${company.name} - Opiniones y Salarios | WorkWisse`} />
        <meta property="og:description" content={company.description} />
        <meta property="og:image" content={company.logo} />
        <meta property="og:type" content="website" />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content={`${company.name} - Opiniones y Salarios | WorkWisse`} />
        <meta name="twitter:description" content={company.description} />
        <meta name="twitter:image" content={company.logo} />
        <link rel="canonical" href={`https://workwisse.com/company/${company.slug}`} />
      </Head>
