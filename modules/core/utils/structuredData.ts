...
export const getCompanyStructuredData = (company: CompanyDocument) => {
  return {
    ...
    description: company.description || `Información y opiniones sobre ${company.companyName}`,
    url: company.website,
...
export const getSearchPageStructuredData = () => {
  return {
    ...
    description: 'Busca y encuentra información sobre empresas, salarios y opiniones de empleados',
