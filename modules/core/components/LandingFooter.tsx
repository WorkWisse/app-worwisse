        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-2 gap-8 mb-12">
          <div className="space-y-4">
            ...
            <div className="flex space-x-3">
              <SocialIcon
                href="https://www.linkedin.com/in/workwisse-workwisse-537095368/"
                title="LinkedIn"
              />
              ...
              />
              <SocialIcon
                href="https://www.facebook.com/profile.php?id=61576610527779"
                title="Facebook"
              />
              <SocialIcon
                href="https://www.tiktok.com/@workwisse"
                title="TikTok"
              />
            </div>
          </div>
