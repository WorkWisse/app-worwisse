...
export const Toast = ({ id, type, title, message, duration = 5000, onClose }: ToastProps) => {
  ...
  const getTypeStyles = () => {
    switch (type) {
      case 'success':
        return {
          cardClass: 'border-l-4 border-green-500 bg-green-50 dark:bg-green-900/20',
      ...
      case 'warning':
        return {
          cardClass: 'border-l-4 border-yellow-500 bg-yellow-50 dark:bg-yellow-900/20',
      ...
      case 'info':
        return {
          cardClass: 'border-l-4 border-blue-500 bg-blue-50 dark:bg-blue-900/20',
      ...
      default:
        return {
          cardClass: 'border-l-4 border-slate-500 bg-slate-50 dark:bg-slate-900/20',
