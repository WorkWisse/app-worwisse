...
const latestReviewsData = [
  ...
  // Add 1-2 more distinct reviews for variety
];
    ...
    <section className="py-20 sm:py-28 bg-slate-100">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-10 lg:gap-12 items-start">
          ...
          {/* Latest Reviews */}
          <div className="lg:col-span-2 space-y-8 animate-fade-in-up delay-500">
            <div className="flex justify-between items-center">
              <h2 className="text-3xl font-bold text-slate-800 tracking-tight">
                Últimas Opiniones
              </h2>
            ...
            {latestReviewsData.map((review, index) => (
              <Card
                key={index}
                className="shadow-lg hover:shadow-xl transition-shadow duration-300 bg-white rounded-xl overflow-hidden"
              >
                  ...
                  <div className="flex items-start justify-between">
                    <div className="flex items-center space-x-4">
                      <img
                        ...
                        alt={`${review.company.name} logo placeholder`}
                        className="h-12 w-12 rounded-full object-cover flex-shrink-0"
                      />
                      <div>
                        <Link
                          href={review.company.href}
